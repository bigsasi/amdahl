...
\begin{frame}[allowframebreaks]{Ley de Gustafson}
    ...
    \end{block}
    \begin{center}
        \includegraphics[width=.4\linewidth]{figures/fixedsize_speedup}
        \includegraphics[width=.4\linewidth]{figures/fixedtime_speedup}
    \end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Speedup ligado a memoria}
    ...
    \end{block}
    \begin{center}
        \includegraphics[width=.4\linewidth]{figures/mb_speedup}
        \includegraphics[width=.4\linewidth]{figures/all_speedups}
    \end{center}
\end{frame}
